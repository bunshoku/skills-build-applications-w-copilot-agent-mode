...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create activities
        Activity.objects.create(user='Iron Man', type='run', duration=30, date='2026-02-17')
        Activity.objects.create(user='Captain America', type='cycle', duration=45, date='2026-02-16')
        Activity.objects.create(user='Thor', type='swim', duration=60, date='2026-02-15')
        Activity.objects.create(user='Superman', type='fly', duration=120, date='2026-02-14')
        Activity.objects.create(user='Batman', type='train', duration=90, date='2026-02-13')
        Activity.objects.create(user='Wonder Woman', type='fight', duration=50, date='2026-02-12')
